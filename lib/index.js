...
Resolver.prototype.lookup = function(record, opts, callback) {
    var self = this
    ...
    var session = new Session(self)
        // async
    nextTick(function() {
        self._resolveOne(self, record, domain, resolveDebug,
            function(result) {
...
Module.prototype.lookup = function(record, opts, callback) {
    return this.defaultResolver.lookup(record, opts, callback)
}
